...
- What/why: [`benchmark-design.md`](benchmark-design.md) §0 · The tasks: [`tasks/README.md`](tasks/README.md) · Commands/schema/gotchas: [`REFERENCE.md`](REFERENCE.md) · Hub: [`README.md`](README.md).
